...
class my_module(nn.Module):
    def __init__(self):
        super().__init__()
        self.my_module_conv1 = nn.Conv2d(256, 256, kernel_size=3, stride=2)
        self.my_module_conv2 = nn.Conv2d(256, 512, kernel_size=3, stride=2)
        self.my_module_conv3 = nn.Conv2d(512, 2048, kernel_size=3, stride=2)
        self.my_module_fc0 = nn.Linear(2048,2048)

        self.avgpool = nn.AdaptiveAvgPool2d((1,1))

        self.my_module_fc1 = nn.Linear(2048,512)
        self.my_module_fc2 = nn.Linear(512,512)
        self.my_module_fc3 = nn.Linear(512,256)
        self.sigmoid = nn.Sigmoid()

        self.my_conv1 = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)
